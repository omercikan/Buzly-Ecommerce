...
function firstProductBasketBtn() {
    const basketBtn = document.getElementsByClassName('add-to-cart');
...
function getProductLinkFirst() {
    const productLink = document.querySelectorAll('.product-link-first');
...
function getProductLinkSecond() {
    const productLink = document.querySelectorAll('.product-link-second');
    productLink.forEach((link) => {
        link.addEventListener('click', (e) => {
            e.preventDefault();
            const id = link.getAttribute('data-id');
...
function addToLikesSecond() {
    const allHeartBtn = document.querySelectorAll('.add-to-likes-second');
    allHeartBtn.forEach((heart) => {
        const heartIcon = heart.querySelector('i');
        const id = heart.getAttribute('data-id');
        if (likes.some((product) => product.id === Number(id))) {
