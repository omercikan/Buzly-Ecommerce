...
document.querySelector<HTMLHeadingElement>('.category-heading h2').innerHTML = categoryName;
document.querySelector<HTMLHeadingElement>('.category-heading span').innerHTML = categoryName;

let cart = [];
cart = localStorage.getItem('cart') ? JSON.parse(localStorage.getItem('cart')) : [];
const addToCart = () => {
    const cartBtn = document.querySelectorAll<HTMLAnchorElement>('.add-to-cart');
    
    Array.from(cartBtn).map((button: HTMLElement): void => {
...
const addToLikes = () => {
    const allHeartBtn = document.querySelectorAll<HTMLButtonElement>('.add-to-likes');
...
const showProductDetail = () => {
    const detailButton = document.querySelectorAll<HTMLButtonElement>('.product-detail');
