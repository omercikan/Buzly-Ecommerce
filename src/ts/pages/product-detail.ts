...
const variationItems = document.querySelectorAll<HTMLDivElement>('.variation-item');
...
const sizesList = document.querySelectorAll<HTMLSpanElement>('.sizes-list span');
...
//!Product heart mode
const productHeart = document.getElementById('productHeart') as HTMLElement;
...
const findFavoriteProduct: boolean = getLikesProduct.find((product) => product.id === activeProduct.id);
...
const sizeCartBtn = document.getElementById('sizeCart') as HTMLDivElement;
const sizeCartContainer = document.querySelector<HTMLDivElement>('.size-cart-container');
